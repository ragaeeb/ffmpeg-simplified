...
- `src/vendor/ffmpegy.ts` is the lightweight wrapper around the locally installed `ffmpeg`/`ffprobe` binaries. Update it instead of reintroducing `ffmpeg-static` or `fluent-ffmpeg`.
